...
// Package fast implements a functional toolkit designed to build hierarchical
...
func (b *Builder[T, N, A]) Lift(fn func(context T) *Builder[T, N, A]) *Builder[T, N, A] {
	return b.Tap(func(x T, parent N) {
		parent.Append(fn(x).Build(x))
	})
}

// Tap is a utility method that abstracts common behaviour required by
// [Builder.Append], [Builder.Annotate], and [Builder.Lift].
func (b *Builder[T, N, A]) Tap(fn func(context T, parent N)) *Builder[T, N, A] {
...
// subtree.
func Scope[T1, T2 any, N Node[N, A], A any](b *Builder[T2, N, A], fn func(T1) T2) *Builder[T1, N, A] {
